...
<body>
    <div class="wrap">
        ...
        <div id="Top">
    <div class="logo">
        <a href="<?php echo U('Public/index');?>"><img src="/test/Public/images/admin/logo.png" />
        </a>
    </div>
...
<script src="/test/Public/bootstrap_modal/jquery-1.7.2.min.js"></script>
<script src="/test/Public/bootstrap_modal/bootstrap-modal.js"></script>
<script  type="text/javascript">
    $(function ()
    { $("#identifier").modal();
    });
