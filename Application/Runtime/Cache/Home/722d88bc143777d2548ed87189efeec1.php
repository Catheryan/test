...
<head>
    ...
    <title>后台管理系统</title>
    <base href="/test/index.php/Home" />
    <!-- css -->
    <link rel="stylesheet" type="text/css" href="/test/Public/Min/?f=/test/Public/stylesheets/admin/base.css|/test/Public/stylesheets/admin/layout.css|/test/Public/javascripts/admin/asyncbox/skins/default.css" />
...
<body>
    <div class="wrap">
        ...
        <div id="Top">
    <div class="logo">
        <a href="<?php echo U('Index/index');?>"><img src="/test/Public/images/admin/logo.png" />
        </a>
    </div>
...
<!--     <div class="help">
    ...
    <div class="menu">
    <ul>
        <?php if(is_array($main_menu)): $i = 0; $__LIST__ = $main_menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu_item): $mod = ($i % 2 );++$i;?><li class="fisrt">
...
<div class="clear"></div>
    ...
    <div class="subMenuList">
        ...
        <ul>
            <?php if(is_array($sub_menu)): $i = 0; $__LIST__ = $sub_menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu_item): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Public/currentsheet');?>"><?php echo ($menu_item); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
</div>
